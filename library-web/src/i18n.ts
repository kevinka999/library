  ...
  en: {
    translation: {
      ...
      forms: {
        ...
        edit: 'Edit book',
        editTitle: 'Edit book',
        editDescription: 'Update the complete catalogue information for this book.',
        save: 'Save changes',
        saving: 'Saving…',
      ...
      history: {
        eyebrow: 'Book history',
        heading: 'History',
        introduction: 'Review complete sets of changes made to this book.',
        changedFields: 'Changed fields',
        changedFrom: 'Changed from (inclusive)',
        changedBefore: 'Changed before (exclusive)',
        sortDirection: 'Order',
        newestFirst: 'Newest first',
        oldestFirst: 'Oldest first',
        applyFilters: 'Apply filters',
        resetFilters: 'Reset history filters',
        loading: 'Loading history…',
        loadingMore: 'Loading more…',
        loadMore: 'Load more',
        end: 'You have reached the end of the history.',
        emptyTitle: 'No history found',
        empty: 'No change sets match these filters.',
        errorTitle: 'History is unavailable',
        error: 'Current book information is still available. Try loading its history again.',
        nextPageError: 'The next history page could not be loaded. Earlier changes are still available.',
        invalidFiltersTitle: 'Invalid history filters',
        invalidFilters: 'Choose valid filters where “changed from” is earlier than “changed before”.',
        created: 'Book created',
        updated: 'Book updated',
        none: 'None',
        added: 'Added <0>{{field}}</0>: <1>{{value}}</1>',
        removed: 'Removed <0>{{field}}</0>: <1>{{value}}</1>',
        changed: 'Changed <0>{{field}}</0> from <1>{{oldValue}}</1> to <2>{{newValue}}</2>',
        fields: {
          title: 'Title',
          shortDescription: 'Short description',
          publishDate: 'Publish date',
      ...
      pagination: {
        ...
        summary_one: 'Page {{page}} of {{totalPages}} · {{totalCount}} book',
        summary_other: 'Page {{page}} of {{totalPages}} · {{totalCount}} books',
        previous: 'Previous',
        next: 'Next',
  ...
  de: {
    translation: {
      ...
      forms: {
        ...
        editDescription: 'Aktualisieren Sie die vollständigen Kataloginformationen für dieses Buch.',
      ...
      history: {
        eyebrow: 'Buchverlauf',
        heading: 'Verlauf',
        introduction: 'Prüfen Sie vollständige Änderungssätze dieses Buches.',
        changedFields: 'Geänderte Felder',
        changedFrom: 'Geändert ab (einschließlich)',
        changedBefore: 'Geändert vor (ausschließlich)',
        sortDirection: 'Reihenfolge',
        newestFirst: 'Neueste zuerst',
        oldestFirst: 'Älteste zuerst',
        applyFilters: 'Filter anwenden',
        resetFilters: 'Verlaufsfilter zurücksetzen',
        loading: 'Verlauf wird geladen…',
        loadingMore: 'Weitere werden geladen…',
        loadMore: 'Mehr laden',
        end: 'Sie haben das Ende des Verlaufs erreicht.',
        emptyTitle: 'Kein Verlauf gefunden',
        empty: 'Keine Änderungssätze entsprechen diesen Filtern.',
        errorTitle: 'Verlauf ist nicht verfügbar',
        error: 'Die aktuellen Buchinformationen sind weiterhin verfügbar. Laden Sie den Verlauf erneut.',
        nextPageError: 'Die nächste Verlaufsseite konnte nicht geladen werden. Frühere Änderungen bleiben verfügbar.',
        invalidFiltersTitle: 'Ungültige Verlaufsfilter',
        invalidFilters: 'Wählen Sie gültige Filter, bei denen „Geändert ab“ vor „Geändert vor“ liegt.',
        created: 'Buch erstellt',
        updated: 'Buch aktualisiert',
        none: 'Kein Wert',
        added: '<0>{{field}}</0> hinzugefügt: <1>{{value}}</1>',
        removed: '<0>{{field}}</0> entfernt: <1>{{value}}</1>',
        changed: '<0>{{field}}</0> von <1>{{oldValue}}</1> zu <2>{{newValue}}</2> geändert',
        fields: {
          title: 'Titel',
          shortDescription: 'Kurzbeschreibung',
          publishDate: 'Erscheinungsdatum',
      ...
      pagination: {
        ...
        summary_one: 'Seite {{page}} von {{totalPages}} · {{totalCount}} Buch',
        summary_other: 'Seite {{page}} von {{totalPages}} · {{totalCount}} Bücher',
        previous: 'Zurück',
        next: 'Weiter',
